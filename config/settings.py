...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,10.10.7.51').split(',')
...
AI_MODEL_NAME = config('AI_MODEL_NAME', default='facebook/blenderbot-400M-distill')
